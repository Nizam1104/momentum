...
const projectFormSchema = z.object({
    ...
    color: z.string().regex(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/, { message: 'Invalid hex color format.' }).default('#60A5FA'), // Default to a blue color
    status: z.nativeEnum(ProjectStatus, { message: 'Invalid project status.' }).default(ProjectStatus.ACTIVE),
...
interface ProjectFormProps {
    ...
    onSubmit: (data: Omit<Project, 'id' | 'userId' | 'progress' | 'createdAt' | 'updatedAt' | 'completedAt'> | Project) => void;
    onCancel: () => void;
}
