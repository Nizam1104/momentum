...
import { MoreVertical, Edit, Trash2, CalendarDays, Flag, CheckCircle, Hourglass, XCircle, ListTodo } from 'lucide-react';
...
export const TaskItem: React.FC<TaskItemProps> = ({ task, onUpdate, onDelete, onEdit }) => {
    ...
    return (
        <Card className="flex items-center p-4 shadow-sm hover:shadow-md transition-shadow duration-200 ease-in-out">
            <Checkbox
                id={`task-${task.id}`}
